  ...
  return (
    <>
      ...
      <div className="min-h-screen w-full flex items-center justify-center bg-[url('../src/assets/Banner/Banner.jpg')] bg-center bg-cover">
        ...
        <div id='style' className='lg:w-[60%] md:w-[75%] w-[85%] md:min-h-[60vh] h-[75vh] rounded-lg flex md:flex-row flex-col md:justify-around md:items-start justify-around items-center  lg:px-[2%] px-[1%] py-[2%] '>
          <div className='lg:w-[42%] md:w-[40%]'>

            <h1 className='text-[#000] font-normal xl:text-7xl text-5xl text-center '>শীঘ্রই দেখা <br /> হচ্ছে </h1>
          </div>
